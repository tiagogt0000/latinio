const CACHE='latinio-shell-1.8.1';
const SHELL=['./','./index.html','./app/main.js','./app/refresh-import.js','./app/activity.js','./app/refresh-cards.js','./app/classroom.js','./app/collection-learning.js','./app/refresh-decks.js','./app/refresh-ui.js','./app/morphology.js','./app/accounts.js','./app/cloud-config.js','./app/sharing-ui.js','./app/multiuser-sync.js','./app/confusions.js','./app/confusion-ui.js','./app/feedback.js','./app/updates.js','./app/core.js','./app/store.js','./app/sync.js','./app/vocabulary.js','./app/style.css','./icon.svg','./icon-brand-180.png','./icon-brand-192.png','./icon-brand-512.png','./manifest.webmanifest'];
...
self.addEventListener('message',event=>{if(event.data?.type==='GET_VERSION')event.ports[0]?.postMessage({version:'1.8.1'});});
