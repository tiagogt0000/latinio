const CACHE='latinio-shell-0.1.0';
const SHELL=['./','./index.html','./app/main.js','./app/core.js','./app/store.js','./app/sync.js','./app/vocabulary.js','./app/style.css','./icon.svg','./icon-192.png','./icon-512.png','./manifest.webmanifest'];
